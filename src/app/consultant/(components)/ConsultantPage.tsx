...
// ---- Motion variants (copied from your page)
const container = {
  hidden: {opacity: 0},
...
type Props = {c: Consultant};

export default function ConsultantPage({c}: Props) {
  const waHref = `https://wa.me/${c.phone}`;
    ...
    <div className="min-h-svh bg-[#dfe2ec] text-[#2f3b69]">
          ...
          >
            ...
            <motion.div variants={pop} className="mx-auto w-full max-w-[320px]">
              <div className="rounded-2xl bg-[#ebe3e1] p-3 shadow-lg ring-1 ring-black/5">
                ...
                >
                  <Image
                    src={c.photo} // StaticImageData or string supported by Next
                    alt={`Foto Profil ${c.name}`}
                    width={420}
                    height={525}
      ...
      <section className="mx-auto max-w-5xl px-4 py-10">
        ...
        >
          ...
          >
            Kenapa Aulora Pants & konsultasi dengan {c.name}?
          </motion.h2>
          <motion.ul
            variants={container}
